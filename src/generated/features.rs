...
impl Feature {
    const fn from_bit(bit: u32, fw: crate::headers::InternalFirmware) -> Option<Self> {
        ...
        match (bit, fw) {
            ...
            (1u32, Betaflight2026_6) => Some(Self::RxUdp),
            ...
            (
                4u32,
                Betaflight2025_12 | Betaflight2026_6 | Betaflight4_2 | Betaflight4_3
                | Betaflight4_4 | Betaflight4_5 | Inav5 | Inav6,
            ) => Some(Self::MotorStop),
            ...
            (8u32, Betaflight2025_12 | Betaflight2026_6) => Some(Self::Opticalflow),
            (
                9u32,
                Betaflight2025_12 | Betaflight2026_6 | Betaflight4_2 | Betaflight4_3
                | Betaflight4_4 | Betaflight4_5,
    ...
    const fn to_bit(self, fw: crate::headers::InternalFirmware) -> Option<u32> {
        ...
        match (self, fw) {
            ...
            (Self::RxUdp, Betaflight2026_6) => Some(1u32),
            ...
            (Self::Opticalflow, Betaflight2025_12 | Betaflight2026_6) => Some(8u32),
            (
                Self::RangeFinder,
                Betaflight2025_12 | Betaflight2026_6 | Betaflight4_2 | Betaflight4_3
                | Betaflight4_4 | Betaflight4_5,
