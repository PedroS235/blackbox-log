...
impl FlightMode {
    const fn from_bit(bit: u32, fw: crate::headers::InternalFirmware) -> Option<Self> {
        ...
        match (bit, fw) {
            ...
            (9u32, Betaflight2025_12 | Betaflight2026_6) => Some(Self::PosHold),
            ...
            (10u32, Betaflight2025_12 | Betaflight2026_6) => Some(Self::GpsRescue),
            (10u32, Betaflight4_2 | Betaflight4_3 | Betaflight4_4 | Betaflight4_5) => {
                Some(Self::CamStab)
            }
            (10u32, Inav5 | Inav6 | Inav7 | Inav8) => Some(Self::Manual),
            (11u32, Betaflight2025_12) => Some(Self::AntiGravity),
            (11u32, Betaflight2026_6) => Some(Self::Autopilot),
            (
                11u32,
                Betaflight4_2 | Betaflight4_3 | Betaflight4_4 | Betaflight4_5 | Inav5 | Inav6
                | Inav7 | Inav8,
            ) => Some(Self::BeeperOn),
            (12u32, Betaflight2025_12) => Some(Self::HeadAdjust),
            (12u32, Betaflight2026_6) => Some(Self::AntiGravity),
            (
                12u32,
                Betaflight4_2 | Betaflight4_3 | Betaflight4_4 | Betaflight4_5 | Inav5 | Inav6
                | Inav7 | Inav8,
            ) => Some(Self::LedLow),
            (13u32, Betaflight2025_12) => Some(Self::CamStab),
            (13u32, Betaflight2026_6) => Some(Self::HeadAdjust),
            ...
            (23u32, Betaflight2025_12) => Some(Self::Airmode),
            (23u32, Betaflight2026_6) => Some(Self::Blackbox),
            ...
            (30u32, Betaflight2025_12) => Some(Self::Turtle),
            (30u32, Betaflight2026_6) => Some(Self::Camera3),
            ...
            (38u32, Betaflight2025_12) => Some(Self::User4),
            (38u32, Betaflight2026_6) => Some(Self::User3),
            ...
            (39u32, Betaflight2025_12) => Some(Self::PidAudio),
            (39u32, Betaflight2026_6) => Some(Self::User4),
            ...
            (40u32, Betaflight2025_12) => Some(Self::AcroTrainer),
            (40u32, Betaflight2026_6) => Some(Self::PidAudio),
            ...
            (41u32, Betaflight2025_12) => Some(Self::VtxControlDisable),
            (41u32, Betaflight2026_6) => Some(Self::AcroTrainer),
            ...
            (42u32, Betaflight2025_12) => Some(Self::LaunchControl),
            (42u32, Betaflight2026_6) => Some(Self::VtxControlDisable),
            ...
            (43u32, Betaflight2025_12) => Some(Self::MspOverride),
            (43u32, Betaflight2026_6) => Some(Self::LaunchControl),
            (43u32, Betaflight4_5) => Some(Self::Ready),
            (43u32, Inav5 | Inav6 | Inav7 | Inav8) => Some(Self::Turtle),
            (44u32, Betaflight2025_12) => Some(Self::StickCommandDisable),
            (44u32, Betaflight2026_6) => Some(Self::MspOverride),
            (44u32, Betaflight4_5) => Some(Self::LapTimerReset),
            (44u32, Inav5 | Inav6 | Inav7 | Inav8) => Some(Self::NavCruise),
            (45u32, Betaflight2025_12) => Some(Self::BeeperMute),
            (45u32, Betaflight2026_6) => Some(Self::StickCommandDisable),
            (45u32, Inav5 | Inav6 | Inav7 | Inav8) => Some(Self::AutoLevel),
            (46u32, Betaflight2025_12) => Some(Self::Ready),
            (46u32, Betaflight2026_6) => Some(Self::BeeperMute),
            (46u32, Inav5 | Inav6 | Inav7 | Inav8) => Some(Self::PlanWpMission),
            (47u32, Betaflight2025_12) => Some(Self::LapTimerReset),
            (47u32, Betaflight2026_6) => Some(Self::Ready),
            (47u32, Inav5 | Inav6 | Inav7 | Inav8) => Some(Self::Soaring),
            (48u32, Betaflight2026_6) => Some(Self::LapTimerReset),
            (48u32, Inav6 | Inav7 | Inav8) => Some(Self::User3),
            (49u32, Betaflight2026_6) => Some(Self::Wpcapture),
    ...
    const fn to_bit(self, fw: crate::headers::InternalFirmware) -> Option<u32> {
        ...
        match (self, fw) {
            ...
            (Self::Althold, Betaflight2025_12 | Betaflight2026_6) => Some(4u32),
            ...
            (Self::VtxControlDisable, Betaflight2025_12) => Some(41u32),
            (Self::AcroTrainer, Betaflight2026_6) => Some(41u32),
            (
                Self::StickCommandDisable,
                Betaflight4_2 | Betaflight4_3 | Betaflight4_4 | Betaflight4_5,
            ) => Some(41u32),
            (Self::MspRcOverride, Inav5 | Inav6 | Inav7 | Inav8) => Some(41u32),
            (Self::LaunchControl, Betaflight2025_12) => Some(42u32),
            (Self::VtxControlDisable, Betaflight2026_6) => Some(42u32),
            (Self::BeeperMute, Betaflight4_2 | Betaflight4_3 | Betaflight4_4 | Betaflight4_5) => {
                Some(42u32)
            }
            (Self::Prearm, Inav5 | Inav6 | Inav7 | Inav8) => Some(42u32),
            (Self::MspOverride, Betaflight2025_12) => Some(43u32),
            (Self::LaunchControl, Betaflight2026_6) => Some(43u32),
            (Self::Ready, Betaflight4_5) => Some(43u32),
            (Self::Turtle, Inav5 | Inav6 | Inav7 | Inav8) => Some(43u32),
            (Self::StickCommandDisable, Betaflight2025_12) => Some(44u32),
            (Self::MspOverride, Betaflight2026_6) => Some(44u32),
            (Self::LapTimerReset, Betaflight4_5) => Some(44u32),
            (Self::NavCruise, Inav5 | Inav6 | Inav7 | Inav8) => Some(44u32),
            (Self::BeeperMute, Betaflight2025_12) => Some(45u32),
            (Self::StickCommandDisable, Betaflight2026_6) => Some(45u32),
            (Self::AutoLevel, Inav5 | Inav6 | Inav7 | Inav8) => Some(45u32),
            (Self::Ready, Betaflight2025_12) => Some(46u32),
            (Self::BeeperMute, Betaflight2026_6) => Some(46u32),
            (Self::PlanWpMission, Inav5 | Inav6 | Inav7 | Inav8) => Some(46u32),
            (Self::LapTimerReset, Betaflight2025_12) => Some(47u32),
            (Self::Ready, Betaflight2026_6) => Some(47u32),
            (Self::Soaring, Inav5 | Inav6 | Inav7 | Inav8) => Some(47u32),
            (Self::LapTimerReset, Betaflight2026_6) => Some(48u32),
            (Self::User3, Inav6 | Inav7 | Inav8) => Some(48u32),
            (Self::Wpcapture, Betaflight2026_6) => Some(49u32),
